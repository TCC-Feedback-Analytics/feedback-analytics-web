 ...
 * Aparece só em Dashboard e Insights; em outras telas retorna null.
 */
export default function InsightsActionBar() {
  ...
  return (
    <>
      <div className="relative z-20 mb-5 flex w-full max-w-full flex-wrap items-center gap-3 rounded-xl border border-(--quaternary-color)/12 bg-(--bg-secondary) p-3">
        <InsightsControlsBar />
