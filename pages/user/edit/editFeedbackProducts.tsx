...
export default function EditFeedbackProducts() {
  ...
  useEffect(() => {
    ...
    if (actionData.ok) {
      toast.success('Catálogo salvo!', actionData.message || 'Catálogo de produtos atualizado.');
    } else {
  ...
  return (
    <div className="font-work-sans space-y-6 pb-8">
      <Header
        description="Gerencie o catálogo de produtos e configure as perguntas de avaliação por item."
      ...
      <CardSimple>
        <div className="relative w-full">
          <FormFeedbackCatalog catalogType="PRODUCT" qrData={data} />
          {isSavingCatalog && (
